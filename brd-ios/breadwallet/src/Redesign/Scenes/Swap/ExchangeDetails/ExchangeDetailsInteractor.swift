...
class ExchangeDetailsInteractor: NSObject, Interactor, ExchangeDetailsViewActions {
    ...
    private func mockData() {
        let card = PaymentCard(type: .buyAch, id: "121", fingerprint: "222", expiryMonth: 5, expiryYear: 2026, scheme: .none, last4: "121", image: nil, accountName: "roks account", status: .statusOk, cardType: .credit)
