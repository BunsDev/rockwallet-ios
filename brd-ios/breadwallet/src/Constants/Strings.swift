...
internal enum L10n {
  ...
  internal enum Buy {
    ...
    /// Currently, minimum for buying with ACH is %@ USD and maximum is %@ USD per day. At the moment lifetime limit is %@ USD.  More info
    /// 
    /// It currently takes 3-5 days to process a purchase with ACH.
    internal static func achLimits(_ p1: Any, _ p2: Any, _ p3: Any) -> String {
      return L10n.tr("Localizable", "Buy.achLimits", String(describing: p1), String(describing: p2), String(describing: p3), fallback: "Currently, minimum for buying with ACH is %@ USD and maximum is %@ USD per day. At the moment lifetime limit is %@ USD.  More info\n\nIt currently takes 3-5 days to process a purchase with ACH.")
    }
    ...
    internal static func buyLimits(_ p1: Any, _ p2: Any) -> String {
      return L10n.tr("Localizable", "Buy.BuyLimits", String(describing: p1), String(describing: p2), fallback: "Currently, minimum for Buy is %@ USD and maximum is %@ USD per day.  More info")
    }
    /// BUY WITH CARD
      ...
      internal enum Instant {
        ...
        internal enum ConfirmationDrawer {
          ...
          internal static func description(_ p1: Any) -> String {
            return L10n.tr("Localizable", "Buy.Ach.Instant.ConfirmationDrawer.Description", String(describing: p1), fallback: "$%@ assets will settle immediately.")
          }
          /// Instant purchase
