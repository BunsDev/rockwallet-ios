...
class CoreSystem: Subscriber {
    ...
    private let queue = DispatchQueue(label: "com.placeholder.app.CoreSystem", qos: .utility)
    private let listenerQueue = DispatchQueue(label: "com.placeholder.app.CoreSystem.listener", qos: .utility)
